...
public enum NetworkPermission {
    ...
    MODIFY_CLAIMS("Claim/Unclaim Land", "Grants the ability to claim and unclaim land", true),
    ...
    MODIFY_SNITCHES("Create Snitches", "Grants the ability to create snitches", true),
    ACCESS_FACTORY("Access Factories", "Grants access to all factories", true),
    MODIFY_FACTORY("Create Factories", "Grants the ability to create factories", true),
